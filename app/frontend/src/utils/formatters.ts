...
export function getCurrentWeekRange(referenceDate: Date): { start: Date; end: Date } {
...
export function getCurrentMonthRange(referenceDate: Date): { start: Date; end: Date } {
...
export function buildDashboardBuckets(sales: Sale[], start: Date, end: Date): DashboardBucket[] {
