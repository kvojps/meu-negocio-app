      ...
      >
        <div className="help-guide">
          ...
          <ol className="help-guide-steps">
            ...
            <li>
              Preencha os campos: nome, descrição, categoria, fornecedor, preço
              de custo, preço de venda, estoque atual e estoque mínimo.
            </li>
            <li>
        ...
        <div className="help-guide">
          ...
          <ol className="help-guide-steps">
            ...
            <li>
              Adicione os itens selecionando produtos do catálogo e definindo as
              quantidades.
            </li>
            <li>
      ...
      >
        <div className="help-faq">
          ...
          <div className="help-faq-item">
            ...
            <p className="help-faq-answer">
              Na listagem, clique no ícone de três pontos (<strong>...</strong>)
              ao lado do item desejado e selecione <strong>Editar</strong>. As
