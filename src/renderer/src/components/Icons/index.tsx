...
export function ProductIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function OrderIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SaleIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SettingIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HelpIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DownloadIcon({ size = 16 }: IconProps) {
  return (
    ...
    >
      <path
        d="M12 3V15M12 15L17 10M12 15L7 10"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function SidebarToggleIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
